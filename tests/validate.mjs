...
const personaSkills = [
  ...
  },
  {
    ...
    required: [
      ...
      "full-profile",
      "[workflows.md](references/workflows.md)",
      "live quote as the exact charge",
      "maximum spend",
      "Never overpay the x402 endpoint",
    ...
    expected: [
      ...
      "no-amount-discover-preview-live-minimum-quote",
      "user-amount-as-max-budget-pay-live-quote",
      "no-amount-recommend-vendor-prepaid-floor-not-quote-dust",
      "quote-covered-still-require-vendor-prepaid-floor",
