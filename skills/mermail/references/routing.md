...
| Explicitly inspect Agent Wallet / PayBox balances or create/submit USDC transfers; never use this route merely because inbound mail mentions payment | `mermail-agent-wallet` |
