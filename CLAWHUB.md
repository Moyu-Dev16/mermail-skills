...
[ClawHub](https://clawhub.ai/) is the OpenClaw public registry for **skills** (`SKILL.md`) and plugins. Mermail publishes the ten workflow skills from this repo under the publisher handle **`mermail`**.
...
```bash
# Preview all ten skills (default)
